package com.tigomi.ereservation.vista.resource;
...
import com.tigomi.ereservation.modelo.Reserva;
import com.tigomi.ereservation.negocio.services.ClienteService;
import com.tigomi.ereservation.negocio.services.ReservaService;
import com.tigomi.ereservation.vista.resource.vo.ReservaVO;
...
public class ReservaResource {
	...
	public ResponseEntity<Reserva> createReserva(@RequestBody ReservaVO reservaVO){
		Cliente cliente = clienteService.findByIdentificacion(reservaVO.getCliente().getIndentificacionCli());
		Reserva reserva = new Reserva();
		reserva.setCliente(cliente);
		reserva.setCodigoRes(reservaVO.getCodigoRes());
		reserva.setFechaIngresoRes((Date) reservaVO.getFechaIngresoRes());
		reserva.setFechaSalidaRes((Date) reservaVO.getFechaSalidaRes());
